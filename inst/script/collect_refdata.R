...
CD8_CDR3b_length <- read.csv(file = "temp_folder/human_v2.0/ref_L_CD8_v2.0.txt",
                             sep = "\t", header = FALSE)
colnames(CD8_CDR3b_length) <- c("CDR3_length_AA", "p")
CD8_TRBV_usage <- read.csv(file = "temp_folder/human_v2.0/ref_V_CD8_v2.0.txt", 
                           sep = "\t", header = FALSE)
...
CD4_CDR3b_length <- read.csv(file = "temp_folder/human_v2.0/ref_L_CD4_v2.0.txt",
                             sep = "\t", header = FALSE)
colnames(CD4_CDR3b_length) <- c("CDR3_length_AA", "p")
CD4_TRBV_usage <- read.csv(file = "temp_folder/human_v2.0/ref_V_CD4_v2.0.txt", 
                           sep = "\t", header = FALSE)
...
CD8 <- read.csv(file = "temp_folder/mouse_v1.0/ref_CD8_ms.txt", sep = "\t", 
                header = FALSE)
colnames(CD8) <- c("CDR3b", "TRBV", "TRBJ")
CD8_CDR3b_length <- read.csv(file = "temp_folder/mouse_v1.0/ref_L_CD8_ms.txt", 
                             sep = "\t", header = FALSE)
colnames(CD8_CDR3b_length) <- c("CDR3_length_AA", "p")
CD8_TRBV_usage <- read.csv(file = "temp_folder/mouse_v1.0/ref_V_CD8_ms.txt", 
                           sep = "\t", header = FALSE)
colnames(CD8_TRBV_usage) <- c("TRBV", "p")
...
CD4 <- read.csv(file = "temp_folder/mouse_v1.0/ref_CD4_ms.txt", sep = "\t", 
                header = FALSE)
colnames(CD4) <- c("CDR3b", "TRBV", "TRBJ")
CD4_CDR3b_length <- read.csv(file = "temp_folder/mouse_v1.0/ref_L_CD4_ms.txt", 
                             sep = "\t", header = FALSE)
colnames(CD4_CDR3b_length) <- c("CDR3_length_AA", "p")
CD4_TRBV_usage <- read.csv(file = "temp_folder/mouse_v1.0/ref_V_CD4_ms.txt", 
                           sep = "\t", header = FALSE)
colnames(CD4_TRBV_usage) <- c("TRBV", "p")
